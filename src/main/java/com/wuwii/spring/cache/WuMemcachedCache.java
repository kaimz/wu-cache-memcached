...
public class WuMemcachedCache extends AbstractValueAdaptingCache {
  ...
  protected Object lookup(Object key) {
    return wuMemcachedFactory.get(key);
  }

  @Override
  public <T> T get(Object key, Callable<T> valueLoader) {
    return wuMemcachedFactory.get(key, valueLoader);
  }

  @Override
  public void put(Object key, Object value) {
    wuMemcachedFactory.put(key, value);
  }

  @Override
  public ValueWrapper putIfAbsent(Object key, Object value) {
    Object o = wuMemcachedFactory.putIfAbsent(key, value);
    return o == null ? null : new SimpleValueWrapper(o);
  }

  @Override
  public void evict(Object key) {
    wuMemcachedFactory.evict(key);
  }
